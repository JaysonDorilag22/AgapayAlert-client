...
import { Bell, MessageCircle, Facebook, Radio, Map, Search } from "lucide-react-native";
...
const BROADCAST_TYPES = [
  ...
  },
  {
    ...
    icon: MessageCircle,
    color: "#10B981",
    description: "Send Notification to registered users",
  },
  {
    id: "Facebook Post",
    icon: Facebook,
      ...
      <View style={tw`flex-1 bg-black/50 justify-center items-center p-4`}>
        <View style={tw`bg-white w-full rounded-xl p-4 max-h-[90%]`}>
                  ...
                  {id === "radius" && scopeType === "radius" && (
                    <>
                      ...
                      <View style={tw`mt-4`}>
                        <RadiusMap
                          center={{
                            lat: currentReport?.location?.coordinates?.[1] || 14.5176,
                            lng: currentReport?.location?.coordinates?.[0] || 121.0509,
                          }}
          ...
          <View style={tw`flex-row justify-end mt-4 pt-4 border-t border-gray-200`}>
            ...
            <TouchableOpacity onPress={handleSubmit} style={tw`bg-blue-600 px-4 py-2 rounded-lg`}>
